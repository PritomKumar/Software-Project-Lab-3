...
class _SurveyTaskState extends State<SurveyTask> {
  ...
  List<String> cardTest = List<String>();
              ...
              children: <Widget>[
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    //region All methods to return selected task And Type of task
                    ...
                    dynamic returnTask() {
                      if (_selectedType == ImageTaskType) {
                        return ImageTask(
                          taskDescription: _instructionController.text,
                          require: _isRequired,
                  ...
                  onPressed: () {
                    for (int i = 0; i < _myKeyList.length; i++) {
                      Future.delayed(Duration(milliseconds: 10), () {
                        print(
                            "Global key at index $i ${_myKeyList[i].currentState.toString()}");
                      });
