...
class ThemeChanger with ChangeNotifier {
  ...
  _loadFromPrefs() async {
    await _initPrefs();
    _themeData = _sharedPreferences.getString(key) ??
        ThemeData(primarySwatch: Colors.blue);
    debugPrint("shared preference = ${_sharedPreferences.getString(key)}");
    notifyListeners();
  }

  _saveToPrefs() async {
    await _initPrefs();
    _sharedPreferences.setString(key, _themeData.toString());
    debugPrint("shared preference = ${_sharedPreferences.getString(key)}");
  }
}
